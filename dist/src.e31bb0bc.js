...
},{"./lib/axios":"../node_modules/axios/lib/axios.js"}],"js/service.js":[function(require,module,exports) {
"use strict";
...
class Api {
  ...
  async fetch() {
    this.incrementPage();
    return await _axios.default.get('https://pixabay.com/api/?key=24625422-32b02834f3df76db1a58654ff', {
      params: {
        q: `${this.serchQuery}`,
        page: `${this.page}`,
        image_type: 'photo',
...
exports.Api = Api;
},{"axios":"../node_modules/axios/index.js"}],"js/hw11.js":[function(require,module,exports) {
"use strict";
...
const onSubmit = e => {
  ...
  try {
    if (service.searchValue === '') return _notiflix.default.Notify.failure('No value entered');
...
},{"../sass/main.scss":"sass/main.scss","notiflix":"../node_modules/notiflix/dist/notiflix-aio-3.2.2.min.js","./service.js":"js/service.js"}],"index.js":[function(require,module,exports) {
"use strict";

require("./sass/main.scss");

require("./js/hw11");
},{"./sass/main.scss":"sass/main.scss","./js/hw11":"js/hw11.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "9611" + '/');
